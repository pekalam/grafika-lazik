	...
	"bryla-glowna", position, rotation, children, color)
{
	...
	join(new SceneObject("bryla-glowna-cz2", {0, 0, 10}, {0, 0, 0}, {
		...
		new ScianaG("bryla-glowna-cz2-11", 2, std::sqrt(3 * 3 + 2 * 2), 2, 3, {-6.5, 0, 4.5}, {-33.691f, 0, 0},
		            {1, 1, 0}),
		new ScianaG("bryla-glowna-cz2-12", 2, std::sqrt(3 * 3 + 2 * 2), 2, 3, {6.5, 0, 4.5}, {-33.691f, 0, 0},
		            {1, 1, 0}),
