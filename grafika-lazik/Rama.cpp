...
Rama::Rama(Vector3 position, Vector3 rotation) : SceneObject("rama", position, rotation)
{
	...
	join(new WalecG(1, 0.75, { 8, pos, 2.0 }, { 0, 90, 0 }, 20, {.289,.289,.289}));
	join(new WalecG(1, 0.75, { -8, pos, 2.0 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(2, 0.75, { 9.5, pos, 10.0 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(2, 0.75, { -9.5, pos, 10.0 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(8.5, 0.5, { 8.5, pos, 6.0 }, { 0, 5.5, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(8.5, 0.5, { -8.5, pos, 6.0 }, { 0, -5.5, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(6, 0.5, { 10, pos2, 7.0 }, { -27.5, 0, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(6, 0.5, { -10, pos2, 7.0 }, { -27.5, 0, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(12, 0.5, { 10, pos2, 16 }, { 13.0, 0, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(12, 0.5, { -10, pos2, 16 }, { 13.0, 0, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { 10, osPos, 4.5 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { -10, osPos, 4.5 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { 10, osPos, 21.75 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { -10, osPos, 21.75 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { -9.85, osPos, -13.75 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));
	join(new WalecG(1, 0.6, { 9.85, osPos, -13.75 }, { 0, 90, 0 }, 20, { .289,.289,.289 }));

	join(new WalecG(16.0, 0.5, { 9, pos, -6 }, { 0, -6, 0 }, 20, {.289, .289, .289}));
	join(new WalecG(16.0, 0.5, { -9, pos, -6 }, { 0, 6, 0 }, 20, { .289, .289, .289 }));
	join(new WalecG(2.0, 0.6, { 9.75, pos, -13.75 }, { 90, 0, 0 }, 20, { .289, .289, .289 }));
	join(new WalecG(2.0, 0.6, { -9.75, pos, -13.75 }, { 90, 0, 0 },20, { .289, .289, .289 }));
